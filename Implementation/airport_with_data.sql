...
--
-- Host: 127.0.0.1
-- Creato il: Giu 03, 2026 alle 02:16
...
(1, 1, '2026-07-02 09:00:00', 'CONFIRMED', 'RYR32KE', 2, 3, 1, 4, NULL),
...
(5, NULL, '2026-06-06 05:52:00', 'NOT_ACCEPTED', 'RYR32KE', 2, 1, 4, 4, NULL);
...
INSERT INTO `parking_spots` (`id`, `spot_number`, `flight_id`) VALUES
(1, 'PA1', NULL),
(2, 'PA2', NULL),
(3, 'PA3', NULL),
(4, 'PA4', NULL),
...
INSERT INTO `planes` (`plane_number`, `model`, `status_id`, `company_id`) VALUES
('DAL222', 'Airbus A330-941', 4, 3),
('RYR32KE', 'Boeing 737 MAX 8-200', 4, 7);

-- --------------------------------------------------------

--
-- Struttura della tabella `plane_status`
--
...
--
-- Dump dei dati per la tabella `plane_status`
--
...
INSERT INTO `users` (`id`, `email`, `password`, `name`, `surname`, `role_id`, `company_id`) VALUES
(1, 'admin@admin.com', 'c7ad44cbad762a5da0a452f9e854fdc1e0e7a52a38015f23f3eab1d80b931dd472634dfac71cd34ebc35d16ab7fb8a90c81f975113d6c7538dc69dd8de9077ec', 'Albert', 'Robinson', 5, NULL),
(2, 'pilot@pilot.com', 'a4317322c01ef6d39c2ec0d46cb5070d973c7ea8c4f744a80c17d8a7b318d8799410f0149bdeca412dcf1510df369b34da3067eb5d4e5b880142ce0013589aff', 'Lucas', 'Fly', 2, 7),
(3, 'pilota@pilota.com', '1d575c9b088d664e83b9c9c04d38a107e6dd75edfed386b4357b1f3578bdd0e8ade0731b4a81a2153e9bf9095251ba4f2aa2bd8f18ff1266aa63886f48b2ff60', 'Luca', 'Volo', 2, 3),
(14, 'analyst@analyst.com', 'cc731411d0924f9ac456d49df60e525cea0d7aad1a652577859d794bfc830276b668f78421a8ed3dbc66f83b0d8e69a49b4779f43f2a56750ea7e25c8718be87', 'ana', 'list', 7, NULL),
(15, 'airline@airline.com', '20e335154f790d5ac446712b2511b83c7292efa88665d9968289c2cdd83c7bbe74f87174faf2340cd6368b76453d592591bddbb4a3d417f71069ca205f8c05a7', 'air', 'line', 6, 7);
...
--
-- Indici per le tabelle `plane_status`
--
ALTER TABLE `plane_status`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `status` (`status`);
...
--
-- AUTO_INCREMENT per la tabella `plane_status`
--
ALTER TABLE `plane_status`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `parking_spots`
  ADD CONSTRAINT `flight_fk3` FOREIGN KEY (`flight_id`) REFERENCES `flights` (`id`);
...
ALTER TABLE `planes`
  ...
  ADD CONSTRAINT `status_fk` FOREIGN KEY (`status_id`) REFERENCES `plane_status` (`id`);
